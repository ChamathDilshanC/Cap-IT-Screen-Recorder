...
[![Release](https://img.shields.io/badge/release-v3.6.0-success?logo=github)](../../releases/latest)
...
[What's new](#-whats-new-in-v330) · [Features](#-features) · [Screenshots](#-screenshots) · [Install](#-installation) · [Shortcuts](#%EF%B8%8F-keyboard-shortcuts) · [Architecture](#-architecture) · [Build from source](#-building-from-source)
...
The current source includes a redesigned **Review & Export workspace** with live composition,
styling presets, a thumbnail timeline and matching MP4/GIF exports.
See [workspace features, architecture, verification and limitations](docs/review-workspace.md).
...
Smart Tracking also provides an optional **instant zoom-out** and an animation-speed control from **0% to 50%**. The default `0%` setting preserves the smooth timing used by previous releases.
...
Grab **`CapIT-Screen-Recorder-Setup-3.6.0.exe`** from
